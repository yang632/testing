...
# -------------------------------------------------------------------------------------------------
    ...
    # 选择值班日期
    def select_duty_time(self,duty_time):
    ...
    def do_add_duty(self,duty_info):
        ...
        self.select_duty_time(duty_info['duty_time'])
        self.click_seve()
        self.click_confirm()
...
#     点击修改
    def click_alter(self):
        # 随机修改
        # 获取纪录总数
        # num = Service.get_num(self.driver, '//*[@id="content"]/div[2]/div[2]/div[2]/div[4]/div[1]/span[1]')
        # 随机选择值班
        # dutynum = random.randint(1, 10)
        # print("num",num,"\tdutynum",dutynum)
        self.driver.find_element_by_xpath(f'//*[@id="duty_table"]/tbody/tr[1]/td[10]/button[2]').click()
        # return dutynum
    ...
    # 选择值班日期
    def alter_duty_time(self,duty_time):
    ...
    def do_alter_duty(self,alter_duty_info):
        ...
        self.alter_duty_time(alter_duty_info['duty_time'])
