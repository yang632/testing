...
class Student:
    ...
    def query_student(self,query_info):
        ...
        self.select_state(query_info["s_state"])
    ...
    #修改最新状态
    def edit_state_stu(self,value):
        state_ele = self.driver.find_element_by_xpath('//*[@id="modifyForm"]/div/div[1]/div[1]/div[6]/select')
        Service.select_text(state_ele, value)


    #修改姓名
    def edit_name(self,edit_name_value):
        edit_name_ele=self.driver.find_element_by_xpath('//*[@id="modifyForm"]/div/div[1]/div[1]/div[1]/input')
        Service.send_input(edit_name_ele,edit_name_value)

    # 修改电话号码
    def edit_tel(self, edit_tel_value):
        edit_tel_ele = self.driver.find_element_by_xpath('//*[@id="modifyForm"]/div/div[1]/div[1]/div[4]/input')
        Service.send_input(edit_tel_ele, edit_tel_value)

    # 修改渠道来源
    def edit_source(self, edit_source_value):
        edit_source_ele = self.driver.find_element_by_xpath('//*[@id="modifyForm"]/div/div[2]/div[1]/select')
        Service.select_text(edit_source_ele, edit_source_value)
    #点击保存
    def click_edit_button(self):
        self.driver.find_element_by_xpath('//*[@id="form-modify"]/div/div/div[2]/button').click()
...
if __name__ == '__main__':
    ...
    query_info={"area":"全部","name":"晒着","direction":"全部","sclass":"全部","state":"全部"}
    student_total={"edit_name":"晒着","edit_state":"在校学习","edit_tel":"13111111111","edit_source":"专属简历"}
    a=Student(driver)
    a.do_edit_student(student_total)